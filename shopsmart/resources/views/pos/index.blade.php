    ...
    return {
        ...
        confirmAddToCart() {
            ...
            if (product.track_stock && quantity > product.stock_quantity) {
                ...
                this.quantityInput = product.stock_quantity;
                return;
            }
...
<div class="space-y-6" x-data="posApp()">
    <!-- Quantity Input Modal -->
    <div 
        x-show="quantityModalOpen" 
        @click.away="quantityModalOpen = false"
        x-cloak
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <input 
                                ...
                                @keydown.enter.prevent="confirmAddToCart()"
                                min="1"
                                :max="selectedProduct && selectedProduct.track_stock ? selectedProduct.stock_quantity : null"
                                class="flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#009245] focus:border-transparent text-center text-lg font-semibold"
                                id="quantityInput"
                            >
                            <button 
                                @click="quantityInput = Math.min(selectedProduct && selectedProduct.track_stock ? selectedProduct.stock_quantity : 9999, quantityInput + 1)"
                                class="px-4 py-2 bg-gray-200 rounded-lg hover:bg-gray-300 font-semibold"
                            >+</button>
                        </div>
                        <div class="mt-2 text-sm text-gray-500" x-show="selectedProduct && selectedProduct.track_stock">
                    ...
                    <div class="flex space-x-3">
                        <button 
                            ...
                            class="flex-1 px-4 py-2 text-white rounded-lg font-semibold transition-colors"
                            style="background-color: #009245;"
                        ...
                        <button 
                            @click="quantityModalOpen = false; selectedProduct = null; quantityInput = 1"
