...
<head>
    <meta charset="utf-8">
    <title>Sales Report - {{ $settings['company_name'] ?? 'ShopSmart' }}</title>
    <style>
        @page {
            margin: 10mm 12mm;
            size: A4;
...
<body>
    ...
    <div class="section">
        <div class="section-header">Top 10 Customers</div>
        <div class="section-content">
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    @foreach($topCustomers as $index => $data)
                    <tr>
    ...
    <div class="footer">
        ...
        <p style="margin-top: 8px;">
            ...
            Sales Report ({{ \Carbon\Carbon::parse($dateFrom)->format('M d, Y') }} - {{ \Carbon\Carbon::parse($dateTo)->format('M d, Y') }})
        </p>
    </div>
</body>
</html>
