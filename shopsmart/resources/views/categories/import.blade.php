...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900">Import Categories</h1>
            <p class="text-gray-600 mt-1">Import categories from CSV file</p>
        </div>
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <div class="bg-white rounded-lg p-4 border border-blue-200">
                    <pre class="text-xs text-gray-700 overflow-x-auto">Electronics,Electronic devices and accessories,true
Food & Beverages,Food items and drinks,true
Clothing,Fashion and apparel,false
Books,Educational and reading materials,true</pre>
                </div>
            </div>
        </div>
        ...
        <div class="mt-4 p-3 bg-blue-100 rounded-lg">
            <p class="text-sm text-blue-700">
                <strong>Important:</strong> Make sure your CSV file is UTF-8 encoded and doesn't contain special characters in headers.
            </p>
        </div>
    </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <div class="mt-2 text-sm text-gray-500">
                        Accepted formats: .csv (Max file size: 10MB)
                    </div>
                </div>
            </div>
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="space-y-3">
                    <label class="flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-700">Skip duplicate categories (by name)</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="auto_slug" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500" checked>
                        <span class="ml-2 text-sm text-gray-700">Auto-generate slugs from names</span>
                    </label>
                    <label class="flex items-center">
    ...
    <div class="bg-gray-50 rounded-lg p-6">
        ...
        <p class="text-gray-600 mb-4">Download a sample CSV file to see the expected format:</p>
        <button onclick="downloadSample()" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-lg transition-colors flex items-center space-x-2">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function showImportResults(data) {
    ...
    let html = `
        <div class="bg-green-50 border border-green-200 rounded-lg p-4">
            ...
            <div class="mt-3 text-sm text-green-700">
                <p>Successfully imported: ${data.imported} categories</p>
    `;
    ...
    html += `
            ...
            <div class="mt-4">
                <a href="{{ route('categories.index') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition-colors">
                    View Categories
                </a>
            </div>
        </div>
...
function downloadSample() {
    const sampleContent = `Electronics,Electronic devices and accessories,true
Food & Beverages,Food items and drinks,true
Clothing,Fashion and apparel,false
Books,Educational and reading materials,true`;
