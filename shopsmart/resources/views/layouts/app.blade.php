        ...
        >
                ...
                <nav class="space-y-1" x-data="{ 
                    ...
                    <div>
                        ...
                        <div x-show="openMenus.inventory" x-transition class="ml-4 mt-1 space-y-1">
                            ...
                            <a href="{{ route('inventory.low-stock') }}" class="flex items-center space-x-3 px-4 py-2 rounded-lg text-sm {{ request()->routeIs('inventory.low-stock') ? 'bg-green-50 text-[#009245]' : 'text-gray-600 hover:bg-gray-50' }}">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
         ...
         <div class="flex-1 lg:ml-64 min-w-0">
            ...
            <header class="bg-white border-b border-gray-200 sticky top-0 z-20">
             ...
             <!-- Page Content -->
             <main class="p-4 sm:p-6 pt-16 lg:pt-6 min-w-0">
                @yield('content')
            </main>
        </div>
    </div>
